# Start-Urban-Commute.ps1 - PowerShell script to check compatibility and start the Urban Commute Assistant

$Host.UI.RawUI.WindowTitle = "Urban Commute Assistant Launcher"

Write-Host "======================================================" -ForegroundColor Cyan
Write-Host "Urban Commute Assistant - Python 3.11.5 Launcher" -ForegroundColor Cyan
Write-Host "======================================================" -ForegroundColor Cyan
Write-Host
...
if (Test-Path $envPath) {
    ...
    Write-Host "Please run setup script first to create the environment." -ForegroundColor Red
