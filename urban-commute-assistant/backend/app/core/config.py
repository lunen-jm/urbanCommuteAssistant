...
class Settings(BaseSettings):
    ...
    WEATHER_API_KEY: str = Field(
        os.environ.get("WEATHER_API_KEY", "32aa402c1136ae5ad8c7413f1abbadc6"), 
        description="OpenWeatherMap API key"
    )
    TRAFFIC_API_KEY: str = Field(
        os.environ.get("TRAFFIC_API_KEY", "AVPo4UqcZGSIMpKFcnj4C8whF9Gab1U0"), 
    ...
    def validate_api_keys(cls, v, values, **kwargs):
        ...
        if not v:
            ...
            # Use hardcoded default values instead of trying to access class attributes
            if field_name == "WEATHER_API_KEY":
                return "32aa402c1136ae5ad8c7413f1abbadc6"
            elif field_name == "TRAFFIC_API_KEY":
                return "AVPo4UqcZGSIMpKFcnj4C8whF9Gab1U0"
